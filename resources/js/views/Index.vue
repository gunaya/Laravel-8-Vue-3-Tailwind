	...
	<div>
			...
			<div class="container mx-auto items-center flex flex-wrap">
				<div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
					<div class="pt-32 sm:pt-0">
						...
						>
							Vue Notus is Free and Open Source. It does not
		...
		<section class="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
								...
								<div class="relative flex flex-col mt-4">
									<div class="px-4 py-5 flex-auto">
										...
										<p class="mb-4 text-blueGray-500">
											Vue Notus comes with a huge number
											of Fully Coded CSS components.
										</p>
									</div>
								</div>
								<div class="relative flex flex-col min-w-0">
									<div class="px-4 py-5 flex-auto">
										...
										<p class="mb-4 text-blueGray-500">
											...
											components for React, NextJS, Vue
											and Angular.
										</p>
									</div>
								</div>
								...
								>
									<div class="px-4 py-5 flex-auto">
										...
										<p class="mb-4 text-blueGray-500">
											...
											sample pages. They are fully coded
											so you can start working instantly.
										</p>
									</div>
								</div>
								<div class="relative flex flex-col min-w-0">
			...
			<div class="container mx-auto overflow-hidden pb-20">
				<div class="flex flex-wrap items-center">
					<div
						class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48"
					>
						<div
						...
						>
							Every element that you need in a product comes built
							in as a component. All components fit perfectly with
							each other and can have different colours.
						</p>
						...
						>
							View All
							<i
								class="fa fa-angle-double-right ml-1 leading-relaxed"
							></i>
						</a>
					</div>
				...
				<div class="flex flex-wrap items-center pt-32">
							...
							<div class="my-4 w-full lg:w-6/12 px-4">
								...
								>
									...
									>
										...
										/>
										<p
											class="text-lg text-white mt-4 font-semibold"
										>
											Svelte
										</p>
									</div>
					...
					>
						...
						<p
							class="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600"
						>
							In order to create a great User Experience some
							components require JavaScript. In this way you can
							manipulate the elements on the page and give more
							options to your users.
						</p>
						<p
							class="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600"
						>
							We created a set of Components that are dynamic and
							come to help you.
						</p>
						<div class="block pb-6">
							<span
					...
					<div class="w-full md:w-5/12 ml-auto px-12 md:px-4">
						<div class="md:pr-12">
							...
							<p
								class="mt-4 text-lg leading-relaxed text-blueGray-500"
							>
								This extension comes a lot of fully coded
								examples that help you get started faster. You
								can adjust the colors and also the programming
								language. You can change the text and images and
								you're good to go.
							</p>
			...
			<div class="justify-center text-center flex flex-wrap mt-24">
				<div class="w-full md:w-6/12 px-12 md:px-4">
					...
					>
						...
						past experience in web templates. Take the examples we
					...
					<div class="w-full lg:w-12/12 px-4 -mt-24">
						<div class="flex flex-wrap">
							<div class="w-full lg:w-4/12 px-4">
								<h5
									class="text-xl font-semibold pb-4 text-center"
								>
									Login Page
								</h5>
			...
			<div class="container mx-auto pb-64">
				<div class="flex flex-wrap justify-center">
					...
					>
						...
						<h3
							class="text-3xl mb-2 font-semibold leading-normal text-white"
						>
							Open Source
						</h3>
						<p
						...
						>
							...
							movement too. You can give this version a try to
							feel the design and also test the quality of the
							code!
						</p>
						<p
							class="text-lg font-light leading-relaxed mt-0 mb-4 text-blueGray-400"
						>
							Get it free on Github and please help us spread the
							news with a Star!
						</p>
						<a
							href="https://github.com/creativetimofficial/vue-notus?ref=vn-index"
					...
					<div
						class="w-full md:w-4/12 px-4 mr-auto ml-auto mt-32 relative"
					>
						<i
			...
			<div class="container mx-auto">
				...
				>
					<div class="w-full text-center lg:w-8/12">
						...
						<p
							class="text-blueGray-500 text-lg leading-relaxed mt-4 mb-4"
						>
							Cause if you do, it can be yours now. Hit the
							buttons below to navigate to get the Free version
							for your next project. Build a new web app or give
...
import patternVue from '../../../public/assets/img/pattern_vue.png'
import componentBtn from '../../../public/assets/img/component-btn.png'
import componentProfileCard from '../../../public/assets/img/component-profile-card.png'
import componentInfoCard from '../../../public/assets/img/component-info-card.png'
import componentInfo2 from '../../../public/assets/img/component-info-2.png'
import componentMenu from '../../../public/assets/img/component-menu.png'
import componentBtnPink from '../../../public/assets/img/component-btn-pink.png'
import documentation from '../../../public/assets/img/documentation.png'
import login from '../../../public/assets/img/login.jpg'
import profile from '../../../public/assets/img/profile.jpg'
import landing from '../../../public/assets/img/landing.jpg'
